...
echo "2. After Joining cluster enter below command at master node to set the role of $worker_node1"
echo "Commands: kubectl label node $worker_node1 node-role.kubernetes.io/worker=worker"
echo 
#
###################################################
